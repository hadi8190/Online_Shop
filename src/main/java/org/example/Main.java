    ...
    public void addItem(){
        ...
        while (!quit) {
            ...
            try {
                ...
                cartService.createCart(productForNew,number, userAccount);
                fishService.createConfirm(userAccount);
                fishService.totalPriceForUser(barcode,number,id);
    ...
    while (!quit6) {
        ...
        switch (choice){
            ...
            case 2:
                ...
                int idForConfirm = scanner.nextInt();
                System.out.println("Do you want confirm your cart:  1.YES   2.NO ");
                int confirm = scanner.nextInt();
                fishService.changeConfirmAgain(idForConfirm,confirm);
                break;
            case 3:
                quit6 = true;
        }
...
public void showTable(){
        ...
        System.out.println("Enter your id: ");
        int id = scanner.nextInt();
        cartService.showTableForCart(id);
}
